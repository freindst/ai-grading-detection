...
def build_interface():
    ...
    with gr.Blocks(title="Grading Assistant", theme=theme, css=custom_css) as app:
        ...
        # System message areas - split into Status and Notifications
        with gr.Row():
            with gr.Column(scale=1):
                status_message = gr.Textbox(
                    label="Status (Current Operation)",
                    interactive=False,
                    max_lines=1,
                    value="Ready"
                )
            with gr.Column(scale=1):
                notification_message = gr.Textbox(
                    label="Notifications (Info & Warnings)",
                    interactive=False,
                    lines=3,
                    max_lines=3,
                    value=""
                            ...
                            with gr.Column(scale=3):
                                ...
                                with gr.Row():
                                    ...
                                    with gr.Column(scale=1):
                                        ...
                                        ai_detection_result = gr.Textbox(
        ...
        create_course_btn.click(
            ...
            outputs=[status_message, notification_message, course_dropdown]
        ).then(
            fn=load_courses_dropdown,
            outputs=[profile_course_dropdown]
        )
        ...
        save_as_new_btn.click(
            ...
            outputs=[status_message, notification_message, selected_course_info, profile_dropdown, profile_list]
        )
        ...
        grade_btn.click(
            ...
            outputs=[grade_result, grading_reason, student_feedback_output,
                     ai_detection_result, context_bar, context_details,
                     raw_llm_output, system_prompt_display, user_prompt_display, status_message, notification_message]
        )
        ...
        mark_as_good_btn.click(
            ...
            outputs=[status_message, notification_message]
        )
        ...
        update_fewshot_btn.click(
            ...
            outputs=[status_message, notification_message, feedback_table]
        )
        ...
        batch_grade_btn.click(
            ...
            outputs=[status_message, notification_message, batch_results]
        )
